                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="mb-4 flex flex-wrap items-center gap-x-4 gap-y-2 leading-7">
                                ...
                                {!item.hasImage && showTags && tags.length > 0 && (
                                    <>
                                        <span className="font-semibold">
                            ...
                            {/* Original Image or Text — 带图题只打印原图，不打印文字 */}
                            {item.hasImage ? (
                            ...
                            {/* Answer — 带图题只打印原图，不打印文字答案 */}
                            {!item.hasImage && showAnswers && item.answerText && (
                                <div className="mb-4">
                            ...
                            {/* Analysis — 带图题只打印原图，不打印文字解析 */}
                            {!item.hasImage && showAnalysis && item.analysis && (
                                <div className="mb-4">
